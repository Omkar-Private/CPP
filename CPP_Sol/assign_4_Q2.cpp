...
switch(choice){
    ...
    break;
     case 5:
        ...
        cout<<"peeked element from copy cunstructor st1 : "<<st1.peek()<<endl;
        cout<<"peeked element from copy cunstructor st2 using = operator : "<<st2.peek()<<endl;
    break;
    default:
